...
export interface ForWomenProps {
  products?: Product[];
}
...
const ProductCard: React.FC<{ product: Product}> = ({ product }) => {
  ...
  return (
    <div className="group relative flex flex-col gap-0 border-none bg-transparent py-10">
...
export const OnlyWomen: React.FC<ForWomenProps> = ({ products = [] }) => {
